...
import api from '../api';
import { StickyNote, Plus, X, Image as ImageIcon, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <div className="col-span-full py-12 text-center text-text-muted">No notes yet. Add one above!</div>
        ) : (
          reminders.map(r => (
            <div key={r.id} className="relative group bg-surface border border-border rounded-xl shadow-sm p-6 hover:shadow-md hover:border-border-strong transition-all flex flex-col">
              <button 
