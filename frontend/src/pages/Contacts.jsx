  ...
  return (
    <div className="bg-surface border border-border rounded-xl shadow-sm overflow-hidden">
      ...
      {loading ? (
        ...
        <div className="p-12 text-center text-text-muted">No contacts found. Send a campaign to add contacts!</div>
      ) : (
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {contacts.map(c => (
              <tr key={c.recipient_email} className="border-b border-border last:border-0 hover:bg-neutral-soft transition-colors">
